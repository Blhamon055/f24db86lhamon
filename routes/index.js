...
router.get('/', function (req, res) {
  res.render('index', { title: 'Frappacino App', user : req.user });
});

router.get('/register', function(req, res) {
  res.render('register', { title: 'Frappacino App Registration'});
});
...
router.get('/login', function(req, res) {
  res.render('login', { title: 'Frappacino App Login', user : req.user });
});
...
/* GET home page. - OLD HOME PAGE CODE*/
